...
typedef enum
{
    ...
    FPC1020_CHIP_1140B = 6,
    FPC1020_CHIP_1140C = 7,
} fpc1020_chip_t;
...
extern int fpc1020_write_cb_test_setup_1140(fpc1020_data_t *fpc1020, bool invert);
