...
{
    if ((chip_type == FPC1020_CHIP_1021A) || (chip_type == FPC1020_CHIP_1021B) || (chip_type == FPC1020_CHIP_1021F))
    {
    ...
    else if ((chip_type == FPC1020_CHIP_1140B) || (chip_type == FPC1020_CHIP_1140C))
    {
        nav_setup.row_skip = 4;
        nav_setup.col_mask = 4;
        nav_setup.crop_x = 0;
    ...
    {
        fpc_log_err("FAILED! chip_type = %d\n", chip_type);
        return -EINVAL;
    }
    ...
    fpc_log_info("OK! nav_setup.size = %d\n", nav_setup.size);
